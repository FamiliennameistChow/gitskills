...
def decode_data(buf, pkg_name, datastr):
    ...
    if pkg_name == "SUBWIN_DAT":
        ...
        for i in range(253):
            ...
            index += 2
        decode_item(buf, "GS1_ID", 90, "I", "bit", datastr[index:index + 2], 0, 15, lambda x: x)
        index += 2
        decode_item(buf, "w1rs", 90, "I", "bit", datastr[index:index + 2], 0, 9, lambda x: x + 1)
        index += 2
        decode_item(buf, "w1cs", 90, "I", "bit", datastr[index:index + 2], 0, 9, lambda x: x + 1)
        index += 2
        for i in range(128):
            ii = i + 1
            decode_item(buf, 'WIN1_SEG' + str(ii) + '_Y', 90, "I", "byte", datastr[index:index + 2], 0, 15, lambda x: x + 1)
            index += 2
            decode_item(buf, 'WIN1_SEG' + str(ii) + '_X', 90, "I", "byte", datastr[index:index + 2], 0, 15, lambda x: x + 1)
            index += 2
            decode_item(buf, 'WIN1_SEG' + str(ii) + '_BKG', 90, "I", "bit", datastr[index:index + 2], 4, 15, lambda x: x)
            decode_item(buf, 'WIN1_SEG' + str(ii) + '_VLD_FLAG', 90, "I", "bit", datastr[index:index + 2], 0, 3, lambda x: x)
            index += 2
            decode_item(buf, 'WIN1_SEG' + str(ii) + '_ENER', 90, "I", "byte", datastr[index:index + 2], 0, 15, lambda x: x)
            index += 2
            decode_item(buf, 'WIN1_SEG' + str(ii) + '_WEIGHTED_ENER_LOW', 90, "I", "byte", datastr[index:index + 2], 0, 15, lambda x: x)
            index += 2
            decode_item(buf, 'WIN1_SEG' + str(ii) + '_LENGTH', 90, "I", "bit", datastr[index:index + 2], 12, 15, lambda x: x+1)
            # decode_item(buf, 'RESERVED', 90, "I", "bit", datastr[index:index+2],10, 11, lambda x: x)
            decode_item(buf, 'WIN1_SEG' + str(ii) + '_WEIGHTED_ENER_HIGHT', 90, "I", "bit", datastr[index:index + 2], 0, 9, lambda x: x)
            index += 2
